...
// John Deppe sez:: I'm hacking this for our case because NUM_SET and NUM_WAY are out of scope here?

#define NUM_CORE 1 // this should be from config!
#define LLC_SETS 2048 // this should be from config, NUM_SET
#define LLC_WAYS 16 // this should be from config, NUM_WAY
